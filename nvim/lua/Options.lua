...
opt.guifont = "FiraCode Nerd Font:h17" -- Set custom font for GUI
...
opt.wildignore =
"*.o,*.a,*.swp,*.so,*.git,*.hg,*.svn,*.DS_Store,*.class,*.log,*.tmp,*.bak,*.exe,*.dll,*.obj,*.pdb,*.pyc,*.pyo,*.db,*.sqlite,*.iml,*.jar,*.zip,*.tar,*.gz,*.tgz,*.rar,*.7z,*.csv,*.docx,*.xlsx,*.pptx,*.pdf,*.mkv,*.mp4,*.avi,*.mp3,*.wav,*.flac,*.iso,*.md5,*.pem,*.key,*.csr,*.crt,*.pub,*.gitignore,*.npmignore" -- Ignored during file completion and commands that require file paths
